...
public class TotpTool {
    ...
    public static String generateTOTP(String secret) {
        return TotpTool.generateTOTP(secret, TotpTool.getCurrentInterval(), CODE_DIGITS);
    }
...
//        System.out.println(generateTOTP("M74F QSV7 P32Y DKXH 4CIN LPCN X6C5 E376",6,30,new Date().getTime()));
        System.out.println(generateTOTP("M74F QSV7 P32Y DKXH 4CIN LPCN X6C5 E376"));
    }
}
